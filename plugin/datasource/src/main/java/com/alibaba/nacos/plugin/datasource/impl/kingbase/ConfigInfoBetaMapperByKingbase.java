 ...
 * @author JasonChen
 */
public class ConfigInfoBetaMapperByKingbase extends AbstractMapper implements ConfigInfoBetaMapper {
    ...
    public MapperResult findAllConfigInfoBetaForDumpAllFetchRows(MapperContext context) {
        ...
        String sql = "SELECT t.id, data_id, group_id, tenant_id, app_name, content, md5, gmt_modified, beta_ips, encrypted_data_key "
                + "FROM (SELECT id FROM config_info_beta ORDER BY id LIMIT " + pageSize + " OFFSET " + startRow + ") g, "
